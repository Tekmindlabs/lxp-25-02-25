...
export const BulkTeacherUpload = () => {
	...
	const uploadMutation = api.teacher.bulkUpload.useMutation({
		onSuccess: (result: UploadResult) => {
			toast.success(`Successfully uploaded ${result.successful} teachers`);
			if (result.failed > 0) {
				toast.error(`Failed to upload ${result.failed} teachers`, {
					description: (
						<div className="mt-2">
				...
				<Tooltip>
					...
					<TooltipContent className="max-w-sm">
						...
						<ul className="list-disc pl-4 space-y-1">
							...
							<li>Required columns: Name, Email, Phone Number, Teacher Type (CLASS/SUBJECT)</li>
							<li>Optional columns: Specialization, Subject IDs (comma-separated), Class IDs (comma-separated)</li>
							<li>First row should be column headers</li>
							<li>Maximum 500 teachers per upload</li>
						</ul>
					</TooltipContent>
				</Tooltip>
			</TooltipProvider>
